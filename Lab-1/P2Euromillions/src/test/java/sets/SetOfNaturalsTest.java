...
public class SetOfNaturalsTest {
    ...
    public void testAddDuplicate() {
        int[] elems = new int[]{10, 10, 20};

        assertThrows(IllegalArgumentException.class, () -> { setA.add(elems); }, "adding duplicate value didn't throw exception");
        assertThrows(IllegalArgumentException.class, () -> { setB.add(10); }, "adding duplicate value didn't throw exception");
        assertThrows(IllegalArgumentException.class, () -> { setA = SetOfNaturals.fromArray(new int[]{10, 10, 20}); }, "adding duplicate value didn't throw exception");
    }
    ...
    public void testEquals() {
        ...
        setA.add(elems);
        assertTrue(setA.equals(setB), "equal sets not interpreted as equal");
    }
