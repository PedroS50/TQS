...
class AddressResolverTest {
    ...
    public void whenBadCoordidates_throwBadArrayindex() throws IOException, URISyntaxException, ParseException {
        when ( httpClient.get( contains("-5000.000000%2C-5000.000000"))).thenThrow(IndexOutOfBoundsException.class);

        assertThrows( IndexOutOfBoundsException.class, () -> {resolver.findAddressForLocation(-5000.000000,-5000.000000); });
    }
}